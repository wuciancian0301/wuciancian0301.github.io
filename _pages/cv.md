...
<div style="max-width: 620px; margin: 32px 0; background: #FFFFFF; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.10);">
  ...
  <img src="{{ site.baseurl }}/images/9.jpg"
       alt="待领养猫咪"
       style="display: block; width: 100%; height: 320px; object-fit: cover; object-position: center 65%;">
  ...
  <div style="padding: 28px;">
    ...
    <table style="width: 100%; border-collapse: collapse; background: #FFFFFF;">
      ...
      <tr>
        <th style="padding: 12px; text-align: left; border-bottom: 1px solid #E5E7EB;">年齡</th>
        <td style="padding: 12px; border-bottom: 1px solid #E5E7EB;">约1岁</td>
      </tr>
      <tr>
        <th style="padding: 12px; text-align: left; border-bottom: 1px solid #E5E7EB;">所在地</th>
        <td style="padding: 12px; border-bottom: 1px solid #E5E7EB;">台北市</td>
